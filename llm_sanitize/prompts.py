...
1. **Input Validation**:  
   - Scan `{user_query}` and `{chat_context}` for suspicious patterns (e.g., `<script>`, `; DROP TABLE`, encoded payloads).  
   - If threats are detected, respond: *"This request contains unsafe content and cannot be processed."*  
